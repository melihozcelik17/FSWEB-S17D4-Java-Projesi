1) ÖRNEK SORU: Öğrenci tablosundaki tüm kayıtları listeleyin.
        ...
        select ograd ,ogrsoyad,sinif from ogrenci where(cinsiyet='E' and sinif = '9A') or (cinsiyet = 'K' and sinif='9B')
        ...
        select * from ogrenci where dtarih between '1889-01-01 ' and '1990-01-01'
